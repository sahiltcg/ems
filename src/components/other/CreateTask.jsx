  ...
  return (
    <div className='p-5 bg-[#1c1c1c] mt-7 rounded'>
            <form className='flex flex-wrap w-full items-start justify-between'>
                ...
                <input className='text-sm py-1 px-2 w-4/5 rounded outline-none bg-transparent border-[1px] border-gray-400 mb-4' type="text" placeholder='Make a project' />
                </div>
                <div>
                ...
                <div>
                <h3 className='text-sm text-gray-300 mb-0.5'>Asigned to</h3>
