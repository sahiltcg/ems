    ...
    <div className='flex h-screen w-screen items-center justify-center'>
        <div className="border-2 border-emerald-600 rounded-xl p-20">
            ...
            onSubmit={(e)=>{
                ...
                <button className='text-white font-semibold outline-none bg-transparent bg-emerald-600 hover:bg-emerald-700 px-32 py-3 text-lg rounded-full mt-10 placeholder:text-orange-400'>Log in</button>
            </form>
        </div>
    </div>
  )
